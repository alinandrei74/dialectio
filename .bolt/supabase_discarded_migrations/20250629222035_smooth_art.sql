...
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456789001'::uuid,
...
INSERT INTO courses (id, title, description, target_language, source_language, total_lessons, estimated_hours, is_premium, image_url) 
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456789002'::uuid,
...
INSERT INTO courses (id, title, description, target_language, source_language, total_lessons, estimated_hours, is_premium, image_url) 
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456789003'::uuid,
...
INSERT INTO courses (id, title, description, target_language, source_language, total_lessons, estimated_hours, is_premium, image_url) 
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456789004'::uuid,
...
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456789011'::uuid,
  c.id,
  'Spanish Basics',
  1,
...
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456789111'::uuid,
  p.id,
  'preparation',
  1
FROM parts p
...
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456781111'::uuid,
  ph.id,
  'exercise',
...
INSERT INTO units (id, phase_id, kind, title, unit_order)
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456781112'::uuid,
  ph.id,
  'exercise',
  'Numbers and Time',
  2
...
INSERT INTO phases (id, part_id, kind, phase_order)
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456789112'::uuid,
  p.id,
  'conversation',
  2
FROM parts p
...
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456781121'::uuid,
  ph.id,
  'situation',
  'Meeting Someone New',
  1,
...
INSERT INTO parts (id, course_id, title, part_order, synopsis) 
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456789021'::uuid,
  c.id,
  'French Fundamentals',
  1,
...
INSERT INTO phases (id, part_id, kind, phase_order)
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456789211'::uuid,
  p.id,
  'preparation',
  1
FROM parts p
...
INSERT INTO units (id, phase_id, kind, title, unit_order)
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456782111'::uuid,
  ph.id,
  'exercise',
...
INSERT INTO units (id, phase_id, kind, title, unit_order)
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456782112'::uuid,
  ph.id,
  'exercise',
...
INSERT INTO parts (id, course_id, title, part_order, synopsis) 
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456789031'::uuid,
  c.id,
  'Portuguese Basics',
  1,
...
INSERT INTO phases (id, part_id, kind, phase_order)
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456789311'::uuid,
  p.id,
  'preparation',
  1
FROM parts p
...
INSERT INTO units (id, phase_id, kind, title, unit_order)
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456783111'::uuid,
  ph.id,
  'exercise',
  'Portuguese Sounds',
  1
...
INSERT INTO units (id, phase_id, kind, title, unit_order)
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456783112'::uuid,
  ph.id,
  'exercise',
  'Basic Portuguese Introductions',
  2
FROM phases ph
JOIN parts p ON p.id = ph.part_id
JOIN courses c ON c.id = p.course_id
...
INSERT INTO parts (id, course_id, title, part_order, synopsis) 
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456789041'::uuid,
  c.id,
...
INSERT INTO phases (id, part_id, kind, phase_order)
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456789411'::uuid,
  p.id,
  'preparation',
  1
FROM parts p
...
INSERT INTO units (id, phase_id, kind, title, unit_order)
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456784111'::uuid,
  ph.id,
  'exercise',
...
INSERT INTO units (id, phase_id, kind, title, unit_order)
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456784112'::uuid,
  ph.id,
  'exercise',
  'Ciao and Italian Greetings',
  2
FROM phases ph
JOIN parts p ON p.id = ph.part_id
JOIN courses c ON c.id = p.course_id
...
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456751111'::uuid,
  u.id,
  u.id,
...
INSERT INTO exercises (id, old_lesson_id, lesson_id, title, instructions, exercise_type, content, points, exercise_order)
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456752111'::uuid,
  u.id,
  u.id,
...
-- Ejercicio básico para portugués
INSERT INTO exercises (id, old_lesson_id, lesson_id, title, instructions, exercise_type, content, points, exercise_order)
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456753111'::uuid,
  u.id,
  u.id,
  'Portuguese Sounds Practice',
  'Select the correct Portuguese pronunciation.',
  'multiple_choice',
  '{"question": "How do you pronounce \"ão\" in Portuguese?", "options": ["ah-oh", "ow (like cow)", "an", "on"], "correct_answer": "ow (like cow)", "explanation": "The Portuguese \"ão\" is pronounced like \"ow\" in English \"cow\"."}'::jsonb,
  10,
  1
FROM units u
JOIN phases ph ON ph.id = u.phase_id
...
JOIN courses c ON c.id = p.course_id
WHERE c.target_language = 'pt' AND c.source_language = 'en' 
AND u.title = 'Portuguese Sounds'
AND NOT EXISTS (SELECT 1 FROM exercises WHERE lesson_id = u.id);

-- Ejercicio básico para italiano
INSERT INTO exercises (id, old_lesson_id, lesson_id, title, instructions, exercise_type, content, points, exercise_order)
SELECT 
  'b1c2d3e4-f5a6-4890-bcde-123456754111'::uuid,
  u.id,
  u.id,
  'Italian Pronunciation Rules',
  'Choose the correct Italian pronunciation rule.',
  'multiple_choice',
  '{"question": "How is \"gn\" pronounced in Italian (like in \"gnocchi\")?", "options": ["g-n (separate)", "ny (like canyon)", "ng (like sing)", "silent"], "correct_answer": "ny (like canyon)", "explanation": "In Italian, \"gn\" is pronounced like \"ny\" in English \"canyon\"."}'::jsonb,
  10,
  1
FROM units u
JOIN phases ph ON ph.id = u.phase_id
...
JOIN courses c ON c.id = p.course_id
WHERE c.target_language = 'it' AND c.source_language = 'en' 
AND u.title = 'Italian Pronunciation'
AND NOT EXISTS (SELECT 1 FROM exercises WHERE lesson_id = u.id);
