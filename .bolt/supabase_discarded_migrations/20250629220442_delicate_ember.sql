/*
  # Create English to Romance Language Courses

  1. New Courses
    - English → Spanish: Complete course with 18 units across 3 parts
    - English → French: Complete course with 18 units across 3 parts  
    - English → Portuguese: Complete course with 18 units across 3 parts
    - English → Italian: Complete course with 18 units across 3 parts

  2. Course Structure
    - Each course has 3 parts (Basic, Intermediate, Advanced)
    - Each part has 2 phases (Preparation exercises, Conversation practice)
    - Each phase has multiple units with exercises and conversation agents
    - Sample exercises included for each course
...
('a1b2c3d4-e5f6-7890-abcd-ef1234551111', 'a1b2c3d4-e5f6-7890-abcd-ef1234561111', 'Basic Greetings', 'Choose the correct Spanish greeting for each situation.', 'multiple_choice', '{
...
('a1b2c3d4-e5f6-7890-abcd-ef1234551112', 'a1b2c3d4-e5f6-7890-abcd-ef1234561111', 'Introductions', 'Complete the sentence with the correct Spanish phrase.', 'fill_blank', '{
...
('a1b2c3d4-e5f6-7890-abcd-ef1234551113', 'a1b2c3d4-e5f6-7890-abcd-ef1234561111', 'Translate Greeting', 'Translate this English phrase to Spanish.', 'translation', '{
...
INSERT INTO exercises (id, lesson_id, title, instructions, exercise_type, content, points, exercise_order) VALUES
('a1b2c3d4-e5f6-7890-abcd-ef1234552111', 'a1b2c3d4-e5f6-7890-abcd-ef1234562111', 'French Sounds', 'Listen and identify the correct French pronunciation.', 'audio', '{
...
('a1b2c3d4-e5f6-7890-abcd-ef1234552112', 'a1b2c3d4-e5f6-7890-abcd-ef1234562111', 'French Accents', 'Choose the word with the correct accent marks.', 'multiple_choice', '{
...
INSERT INTO exercises (id, lesson_id, title, instructions, exercise_type, content, points, exercise_order) VALUES
('a1b2c3d4-e5f6-7890-abcd-ef1234553111', 'a1b2c3d4-e5f6-7890-abcd-ef1234563111', 'Portuguese Pronunciation', 'Select the correct Portuguese pronunciation.', 'multiple_choice', '{
...
('a1b2c3d4-e5f6-7890-abcd-ef1234553112', 'a1b2c3d4-e5f6-7890-abcd-ef1234563111', 'Basic Portuguese', 'Complete the Portuguese greeting.', 'fill_blank', '{
...
INSERT INTO exercises (id, lesson_id, title, instructions, exercise_type, content, points, exercise_order) VALUES
('a1b2c3d4-e5f6-7890-abcd-ef1234554111', 'a1b2c3d4-e5f6-7890-abcd-ef1234564111', 'Italian Sounds', 'Choose the correct Italian pronunciation rule.', 'multiple_choice', '{
...
('a1b2c3d4-e5f6-7890-abcd-ef1234554112', 'a1b2c3d4-e5f6-7890-abcd-ef1234564111', 'Italian Greeting', 'Translate this greeting to Italian.', 'translation', '{
