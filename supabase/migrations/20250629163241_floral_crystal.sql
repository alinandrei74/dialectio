/*
  ...
  1. Datos de muestra
    - Cursos de francés, portugués e italiano desde español
    - Estructura completa: partes, fases, unidades y ejercicios
    - Contenido educativo real y estructurado

  2. Estructura de datos
    - Cursos → Partes → Fases → Unidades → Ejercicios
    - Unidades de conversación con agentes IA
    - Ejercicios con contenido JSONB válido

  3. Seguridad
    - Políticas RLS completas
    - Acceso público a contenido educativo
...
-- Insertar ejercicios con contenido JSONB estructurado
-- IMPORTANTE: Usar tanto old_lesson_id como lesson_id para compatibilidad
INSERT INTO exercises (old_lesson_id, lesson_id, title, instructions, exercise_type, content, points, exercise_order) VALUES
-- Francés - Saludos Básicos
('850e8400-e29b-41d4-a716-446655440001', '850e8400-e29b-41d4-a716-446655440001', 'Saludo Formal', 'Elige la forma correcta de saludar formalmente en francés', 'multiple_choice', $${
...
('850e8400-e29b-41d4-a716-446655440001', '850e8400-e29b-41d4-a716-446655440001', 'Completar Saludo', 'Completa la frase de saludo', 'fill_blank', $${
...
('850e8400-e29b-41d4-a716-446655440002', '850e8400-e29b-41d4-a716-446655440002', 'Traducir Presentación', 'Traduce esta presentación al francés', 'translation', $${
...
('850e8400-e29b-41d4-a716-446655440002', '850e8400-e29b-41d4-a716-446655440002', 'Respuesta Formal', 'Elige la respuesta correcta', 'multiple_choice', $${
...
('850e8400-e29b-41d4-a716-446655440003', '850e8400-e29b-41d4-a716-446655440003', 'Vocabulario de Comida', 'Traduce al francés', 'translation', $${
...
('850e8400-e29b-41d4-a716-446655440003', '850e8400-e29b-41d4-a716-446655440003', 'Precios en Francés', 'Completa la frase', 'fill_blank', $${
  "question": "Ça coûte _____ euros, s'il vous plaît.",
  "correct_answer": "cinq",
  "acceptable_answers": ["5", "cinco"],
  "case_sensitive": false,
  "explanation": "\"Cinq\" es cinco en francés. También se acepta el número \"5\".",
  "hints": ["Es un número", "Se pronuncia \"sank\""]
}$$, 10, 2),

-- Portugués - Primeiras Palavras
('850e8400-e29b-41d4-a716-446655440007', '850e8400-e29b-41d4-a716-446655440007', 'Saudação Básica', 'Escolha a saudação correta em português', 'multiple_choice', $${
...
('850e8400-e29b-41d4-a716-446655440007', '850e8400-e29b-41d4-a716-446655440007', 'Completar Frase', 'Complete a frase em português', 'fill_blank', $${
...
('850e8400-e29b-41d4-a716-446655440008', '850e8400-e29b-41d4-a716-446655440008', 'Números Básicos', 'Traduzca al portugués', 'translation', $${
...
('850e8400-e29b-41d4-a716-446655440008', '850e8400-e29b-41d4-a716-446655440008', 'Cores Básicas', 'Escolha a cor correta', 'multiple_choice', $${
  "question": "Como se diz \"azul\" em português?",
  "options": ["azul", "azuis", "azulado", "azulão"],
  "correct_answer": "azul",
  "explanation": "\"Azul\" é igual em português e espanhol.",
  "hints": ["É igual ao espanhol", "Não muda"]
}$$, 10, 2),

-- Italiano - Saluti Italiani
('850e8400-e29b-41d4-a716-446655440013', '850e8400-e29b-41d4-a716-446655440013', 'Saluto Informale', 'Scegli il saluto informale corretto', 'multiple_choice', $${
...
('850e8400-e29b-41d4-a716-446655440013', '850e8400-e29b-41d4-a716-446655440013', 'Traduzione Presentazione', 'Traduci in italiano', 'translation', $${
...
('850e8400-e29b-41d4-a716-446655440014', '850e8400-e29b-41d4-a716-446655440014', 'Membri della Famiglia', 'Completa la frase', 'fill_blank', $${
...
('850e8400-e29b-41d4-a716-446655440014', '850e8400-e29b-41d4-a716-446655440014', 'Età della Famiglia', 'Traduci in italiano', 'translation', $${
  "question": "Mi hermana tiene quince años",
  "correct_answer": "Mia sorella ha quindici anni",
  "acceptable_answers": ["La mia sorella ha quindici anni"],
  "source_language": "es",
  "target_language": "it",
  "explanation": "\"Mia sorella\" = mi hermana, \"ha\" = tiene, \"quindici\" = quince, \"anni\" = años",
  "hints": ["\"Sorella\" = hermana", "\"Ha\" = tiene", "\"Quindici\" = quince"]
}$$, 15, 2);
