...
exercises_saludos AS (
  ...
  SELECT pu.id, v.ex_title, v.ex_instructions, v.ex_type, v.ex_content::jsonb, v.ex_points, v.ex_order
...
INSERT INTO exercises (lesson_id, title, instructions, exercise_type, content, points, exercise_order)
SELECT uf.id, v.ex_title, v.ex_instructions, v.ex_type, v.ex_content::jsonb, v.ex_points, v.ex_order
FROM units_fr uf
CROSS JOIN LATERAL (VALUES
...
INSERT INTO exercises (lesson_id, title, instructions, exercise_type, content, points, exercise_order)
SELECT up.id, v.ex_title, v.ex_instructions, v.ex_type, v.ex_content::jsonb, v.ex_points, v.ex_order
FROM units_pt up
CROSS JOIN LATERAL (VALUES
...
INSERT INTO exercises (lesson_id, title, instructions, exercise_type, content, points, exercise_order)
SELECT ui.id, v.ex_title, v.ex_instructions, v.ex_type, v.ex_content::jsonb, v.ex_points, v.ex_order
FROM units_it ui
CROSS JOIN LATERAL (VALUES
