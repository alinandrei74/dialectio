/*
  # Reestructuración de Base de Datos para Flujo Pedagógico de Dialectio

  ## Cambios principales:
  1. Nueva estructura: Curso → Parte → Fase → Unidad
  2. Migración de lessons existentes a units
  3. Nuevas tablas para intentos y sesiones de chat
  4. Validación mejorada de contenido de ejercicios
  5. Índices optimizados para rendimiento

  ## Estructura pedagógica:
  - Cada Curso se descompone en Partes (capítulos)
  - Cada Parte contiene dos Fases fijas: preparación y conversación
  - Cada Fase alberga varias Unidades (exercise o situation)
  - Las lecciones existentes se convierten en Unidades de preparación
*/
...
-- ============================================================================
-- 8. CREAR VISTA LESSONS PARA COMPATIBILIDAD
-- ============================================================================

-- Vista de solo lectura para mantener compatibilidad con código legacy
CREATE OR REPLACE VIEW lessons AS
SELECT 
  u.id,
  p.course_id,
  u.title,
  'Descripción generada desde unit' as description,
  'Contenido generado desde unit' as content,
  u.unit_order as lesson_order,
  'vocabulary' as lesson_type, -- Tipo por defecto
