/*
  ...
  1. Estructura de datos
    - Cursos con idiomas de origen y destino
    - Partes organizadas por curso
    - Fases de preparación y conversación
    - Unidades con ejercicios y situaciones
    - Ejercicios con contenido JSONB estructurado

  2. Datos de muestra
    - 3 cursos completos (ES→FR, ES→PT, ES→IT)
    - Múltiples partes por curso
    - Ejercicios variados con contenido real
    - Situaciones de conversación

  3. Seguridad
    - RLS habilitado en todas las tablas
    - Políticas de acceso público para contenido
    - Políticas de usuario para progreso y sesiones
*/
...
('850e8400-e29b-41d4-a716-446655440007', 'Completar Frase', 'Complete a frase em português', 'fill_blank', '{
  ...
  "correct_answer": "João",
  "acceptable_answers": ["joão", "Maria", "maria", "Ana", "ana"],
  "case_sensitive": false,
