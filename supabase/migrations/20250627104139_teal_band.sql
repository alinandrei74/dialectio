/*
  ...
  1. Security Updates
    ...
    - Update `sync_full_name_with_username` function with explicit search_path
    
  2. Changes
    - Both functions now have `SET search_path = public, pg_temp` for security
...
-- Update the sync_full_name_with_username function with explicit search_path
...
-- Add sample data with proper UUID generation
DO $$
DECLARE
