/*
  # Migración completa del sistema de aprendizaje con datos de muestra en italiano

  1. Nuevas Tablas
    - `courses` - Cursos de idiomas
    - `parts` - Partes de cada curso
    - `phases` - Fases (preparación y conversación)
    - `units` - Unidades de ejercicios y situaciones
    - `attempts` - Intentos de ejercicios del usuario
    - `chat_sessions` - Sesiones de chat con agentes
    - `chat_turns` - Turnos de conversación

  2. Tablas Actualizadas
    - `exercises` - Actualizada para referenciar units
    - `user_progress` - Actualizada para nueva estructura
  ...
  4. Datos de Muestra
    - Curso completo de italiano con ejercicios
    - Pistas y explicaciones en italiano
    - Agentes configurados para conversación en italiano
*/
