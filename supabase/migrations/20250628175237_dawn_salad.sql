/*
  # Crear ejercicios detallados para cada lección

  1. Ejercicios variados por tipo
  2. Contenido específico para cada idioma
  3. Progresión de dificultad apropiada
*/
...
-- Continuar con más ejercicios para otras lecciones...
-- (Por brevedad, incluyo solo algunos ejemplos representativos)

-- ============================================================================
-- EJERCICIOS ADICIONALES PARA DIFERENTES TIPOS
-- ============================================================================
