/*
  # Fix course filtering and add comprehensive sample data

  1. New Courses
    - Add courses for all language combinations
    - Ensure proper source_language mapping
    - Add variety for different user base languages

  2. Data Structure
    - Italian course from Spanish (existing)
    - French course from Spanish  
    - Portuguese course from Spanish
    - English course from Spanish
    - Spanish course from English
    - French course from English
    - Italian course from English
    - Portuguese course from English
    - And more combinations

  3. Security
    - All courses are public readable
