/*
  # Migración completa del sistema de aprendizaje

  1. Nuevas Tablas
    - `courses` - Cursos de idiomas
    - `parts` - Partes de cada curso
    - `phases` - Fases (preparación/conversación)
    - `units` - Unidades (ejercicios/situaciones)
  ...
  3. Datos de Muestra
    - Curso de italiano con estructura completa
    - Ejercicios con pistas en italiano
    - Agentes conversacionales en italiano
*/
...
-- Limpiar cursos existentes con el mismo par de idiomas
DELETE FROM courses WHERE target_language = 'it' AND source_language = 'es';
...
-- 5. Unidades de conversación (situaciones) con agentes en italiano
