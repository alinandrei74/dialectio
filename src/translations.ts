...
export const translations: Record<string, Translation> = {
  es: {
    ...
    ourStoryDescription: 'Todo comenzó cuando nuestro fundador, un políglota apasionado, se dio cuenta de que podía aprender italiano en la mitad del tiempo esperado simplemente porque ya hablaba español. Esta revelación lo llevó a investigar las conexiones entre las lenguas romances y a desarrollar un método que aprovecha estas similitudes naturales.',
  ...
  fr: {
    ...
    ourStoryDescription: 'Tout a commencé quand notre fondateur, un polyglotte passionné, s\'est rendu compte qu\'il pouvait apprendre l\'italien en moitié moins de temps que prévu simplement parce qu\'il parlait déjà espagnol. Cette révélation l\'a amené à rechercher les connexions entre les langues romanes et à développer une méthode qui tire parti de ces similitudes naturelles.',
  ...
  pt: {
    ...
    ourStoryDescription: 'Tudo começou quando nosso fundador, um poliglota apaixonado, percebeu que podia aprender italiano na metade do tempo esperado simplesmente porque já falava espanhol. Esta revelação o levou a pesquisar as conexões entre as línguas românicas e a desenvolver um método que aproveita essas semelhanças naturais.',
  ...
  it: {
    ...
    ourStoryDescription: 'Tutto è iniziato quando il nostro fondatore, un poliglotta appassionato, si è reso conto che poteva imparare l\'italiano nella metà del tempo previsto semplicemente perché parlava già spagnolo. Questa rivelazione lo ha portato a ricercare le connessioni tra le lingue romanze e a sviluppare un metodo che sfrutta queste somiglianze naturali.',
  ...
  en: {
    ...
    ourStoryDescription: 'It all began when our founder, a passionate polyglot, realized he could learn Italian in half the expected time simply because he already spoke Spanish. This revelation led him to research the connections between Romance languages and develop a method that leverages these natural similarities.',
