...
export const translations: Record<string, Translation> = {
  ...
  pt: {
    ...
    aboutDescription2: 'Nascemos com a intenção de criar uma forma de aprender que leve em conta a conexão das línguas e fazer com que você aproveite seus conhecimentos prévios. Quando você fala espanhol, já tem as bases para entender francês. Se conhece italiano, o português lhe parecerá familiar.',
    aboutDescription3: 'Com dialectio.xyz você não fará apenas exercícios de preencher lacunas e ordenar palavras. Não vamos te entediar com gramática. Acreditamos que aprender uma língua é usá-la. Nosso sistema se baseia em criar situações reais onde o estudante tenha a oportunidade de usar a língua que está aprendendo assim como sua cultura.',
    ...
    faqAnswer1: 'Dialectio.xyz é uma plataforma online concebida para acelerar o aprendizado a partir de línguas similares. Parte de um princípio simples: se você já domina uma língua como espanhol, italiano, francês ou português, possui uma grande parte do caminho percorrido em direção às demais. O sistema identifica essas correspondências —lexicais, gramaticais e fonéticas— e as converte em atalhos práticos e prioridades. O aprendizado se articula em duas frentes complementares. Por um lado, conversas guiadas com tutores virtuais que simulam situações reais e com os quais você falará; por outro, exercícios tradicionais prévios à fase de conversação, onde aprenderá os rudimentos básicos para se desenvolver em uma situação real. A combinação de uso imediato e reflexão consciente permite avançar rapidamente e reter de forma duradoura.',
    
    faqQuestion2: 'Que idiomas posso aprender no Dialectio.xyz?',
    faqAnswer2: 'Na versão atual são oferecidos espanhol, francês, italiano e português. O catálogo crescerá gradualmente, primeiro com outras línguas da mesma família —catalão, galego, romeno— e depois com outras línguas, mantendo sempre este enfoque na familiaridade entre línguas.',
    
    faqQuestion3: 'Preciso ter conhecimentos prévios de alguma das línguas atuais para usar Dialectio.xyz?',
    faqAnswer3: 'Não é imprescindível. O sistema admite o inglês como língua de apoio para explicações e dicas básicas. No entanto, seu design obtém o máximo rendimento quando o usuário já domina, mesmo que parcialmente, pelo menos uma língua românica: cada semelhança reconhecida se converte então em um impulso de compreensão e em uma economia de esforço.',
    
    faqQuestion4: 'Qual é a diferença entre Dialectio.xyz e outras plataformas de aprendizado de idiomas?',
    faqAnswer4: 'A maioria dos programas ensina cada língua isoladamente, como se você começasse do zero. Dialectio.xyz parte do que você já sabe. Explora raízes comuns, padrões morfológicos compartilhados e falsos cognatos característicos entre línguas aparentadas. Dessa forma evita redundâncias e centra a atenção nos verdadeiros pontos de divergência. Além disso, a prática não se reduz a ginástica gramatical: as conversas, os relatos e as tarefas funcionais geram exposição autêntica e reforçam a confiança comunicativa.',
    
    faqQuestion5: 'Como se estrutura o aprendizado no Dialectio.xyz?',
    faqAnswer5: 'Cada sessão se organiza em torno de um micro-objetivo comunicativo: cumprimentar um vizinho, pedir café, descrever um itinerário, responder em uma entrevista e em conjunto constroem uma história no país da língua, sua história. O primeiro passo são exercícios tradicionais que te dão os rudimentos básicos para se desenvolver, o segundo te lança a situações reais nas quais praticar a língua em seu contexto cultural.',
    ...
    faqAnswer7: 'Apenas criar uma conta e ter conexão à internet. Tudo acontece no navegador: não há downloads nem instalações. Desde o primeiro acesso obterá um diagnóstico do seu nível e uma rota de aprendizado personalizada que pode seguir no computador, tablet ou celular.',
    
    faqQuestion8: 'Que papel desempenha a motivação para o aprendizado no Dialectio.xyz?',
    faqAnswer8: 'No Dialectio.xyz a motivação talvez não acompanhe o usuário desde o primeiro minuto, mas é considerada essencial para que o processo continue. Por isso o design didático está orientado a gerá-la em lugar de pressupô-la. Cada atividade coloca o aprendiz em um contexto significativo onde os resultados aparecem logo e são tangíveis: entender uma piscadela cultural em uma música, fechar uma reserva de hospedagem, ou responder com desenvoltura em uma ligação. Essa utilidade provoca curiosidade, alimenta o desejo de continuar e transforma a motivação em uma consequência natural, nunca em uma barreira inicial.',
    ...
    // Footer
    footerDescription: 'As línguas não se acabam, continuam. Aprenda espanhol, francês, português e italiano de forma inteligente e eficiente.',
    resources: 'Recursos',
    blog: 'Blog',
    help: 'Ajuda',
    contact: 'Contato',
  ...
  it: {
    ...
    aboutDescription2: 'Siamo nati con l\'intenzione di creare un modo di imparare che tenga conto della connessione delle lingue e ti faccia sfruttare le tue conoscenze precedenti. Quando parli spagnolo, hai già le basi per capire il francese. Se conosci l\'italiano, il portoghese ti sembrerà familiare.',
    ...
    faqAnswer1: 'Dialectio.xyz è una piattaforma online concepita per accelerare l\'apprendimento da lingue simili. Parte da un principio semplice: se già padroneggi una lingua come lo spagnolo, l\'italiano, il francese o il portoghese, possiedi una gran parte del cammino percorso verso le altre. Il sistema identifica quelle corrispondenze —lessicali, grammaticali e fonetiche— e le converte in scorciatoie pratiche e priorità. L\'apprendimento si articola su due fronti complementari. Da una parte, conversazioni guidate con tutor virtuali che simulano situazioni reali e con cui parlerai; dall\'altra, esercizi tradizionali precedenti alla fase di conversazione, dove imparerai i rudimenti di base per cavartela in una situazione reale. La combinazione di uso immediato e riflessione consapevole permette di avanzare rapidamente e di trattenere in modo duraturo.',
    
    faqQuestion2: 'Quali lingue posso imparare su Dialectio.xyz?',
    faqAnswer2: 'Nella versione attuale si offrono spagnolo, francese, italiano e portoghese. Il catalogo crescerà gradualmente, prima con altre lingue della stessa famiglia —catalano, galiziano, rumeno— e poi con altre lingue, mantenendo sempre questo approccio sulla familiarità tra lingue.',
    
    faqQuestion3: 'Ho bisogno di conoscenze precedenti di qualcuna delle lingue attuali per usare Dialectio.xyz?',
    faqAnswer3: 'Non è indispensabile. Il sistema ammette l\'inglese come lingua di supporto per spiegazioni e suggerimenti di base. Tuttavia, il suo design ottiene il massimo rendimento quando l\'utente già padroneggia, anche se parzialmente, almeno una lingua romanza: ogni somiglianza riconosciuta si converte allora in uno slancio di comprensione e in un risparmio di sforzo.',
    ...
    faqQuestion7: 'Di cosa ho bisogno per iniziare?',
    ...
    // Footer
    footerDescription: 'Le lingue non si finiscono, continuano. Impara spagnolo, francese, portoghese e italiano in modo intelligente ed efficiente.',
    resources: 'Risorse',
    blog: 'Blog',
    help: 'Aiuto',
    contact: 'Contatto',
  ...
  en: {
    ...
    // Language Descriptions
    spanishDescription: 'Native language of 500 million people',
    ...
    faqQuestion8: 'What role does motivation play in learning at Dialectio.xyz?',
    faqAnswer8: 'At Dialectio.xyz, motivation may not accompany the user from minute zero, but it is considered essential for the process to continue. Therefore, the didactic design is oriented toward generating it rather than presupposing it. Each activity places the learner in a meaningful context where results appear soon and are tangible: understanding a cultural wink in a song, closing an accommodation reservation, or responding confidently in a call. This utility provokes curiosity, feeds the desire to continue, and transforms motivation into a natural consequence, never an initial barrier.',
