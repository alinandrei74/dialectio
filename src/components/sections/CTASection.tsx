  ...
  return (
    <section className="py-21 bg-white/10 dark:bg-gray-900/20 backdrop-blur-md relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="bg-white/25 dark:bg-gray-800/40 backdrop-blur-md p-7 max-w-4xl mx-auto mb-10 border-4 border-black dark:border-gray-300 transform rotate-1 shadow-2xl"
        ...
        <div className="flex flex-col sm:flex-row gap-7 justify-center items-center">
          <button className="bg-white dark:bg-gray-200 text-green-800 dark:text-gray-900 px-10 py-5 hover:bg-gray-100 dark:hover:bg-gray-300 transition-all duration-300 flex items-center space-x-3 text-lg font-black border-4 border-black dark:border-gray-600 shadow-2xl hover:shadow-3xl hover:scale-105"
