  ...
  return (
    <section id="nosotros" className="py-21 bg-gradient-to-b from-gray-200/90 to-green-100/90 backdrop-blur-md relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Contenedores de texto en disposición horizontal - sin rotación */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 xl:gap-8 mb-21">
          <div className="bg-white/90 backdrop-blur-md p-6 border-4 border-black shadow-xl">
            <p className="text-sm text-gray-900 leading-relaxed font-bold">
              {t.aboutDescription1}
            </p>
          </div>
          <div className="bg-green-50/90 backdrop-blur-md p-6 border-4 border-black shadow-xl">
            <p className="text-sm text-gray-900 leading-relaxed font-bold">
              {t.aboutDescription2}
            </p>
          </div>
        ...
        {/* Sección de estadísticas mejorada - sin rotación */}
        <div className="mb-21">
          <div className="bg-white/95 backdrop-blur-md p-9 shadow-2xl border-4 border-black max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 gap-5">
              <div className="text-center p-5 bg-green-50/90 border-3 border-black shadow-lg">
              ...
              <div className="text-center p-5 bg-gray-50/90 border-3 border-black shadow-lg">
        ...
        {/* Tarjetas de información en disposición horizontal - sin rotación */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 xl:gap-8">
          <div className="bg-white/90 backdrop-blur-md p-8 shadow-xl text-center border-4 border-black">
          ...
          <div className="bg-green-50/90 backdrop-blur-md p-8 shadow-xl text-center border-4 border-black">
