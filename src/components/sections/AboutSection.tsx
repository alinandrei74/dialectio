...
function AboutSection({ t }: AboutSectionProps) {
  return (
    <section id="nosotros" className="py-21 bg-white/10 dark:bg-gray-900/20 backdrop-blur-md relative">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 right-10 w-16 h-16 bg-gradient-to-br from-green-700 to-green-900 dark:from-green-600 dark:to-green-800 transform rotate-45 opacity-25 shadow-xl"></div>
        <div className="absolute bottom-20 left-10 w-4 h-48 bg-black dark:bg-gray-300 transform -rotate-30 opacity-25 shadow-lg"></div>
      </div>
        ...
        <div className="mb-21">
          <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-md p-9 shadow-2xl border-4 border-black dark:border-gray-300 transform -rotate-1 max-w-4xl mx-auto"
            ...
            <div className="flex items-center space-x-5 mb-7">
              ...
              <div>
                <h3 className="text-xl font-black text-gray-900 dark:text-gray-100">Pasión por las lenguas</h3>
                <p className="text-gray-700 dark:text-gray-300 font-bold text-sm">Conectando culturas a través del idioma</p>
              </div>
            </div>
